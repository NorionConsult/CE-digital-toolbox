...
export const toolsPage = {
  ...
  eyebrow: { en: 'Selected tools to support small-medium enterprises (SMEs)', uk: 'Відібрані інструменти для підтримки малих і середніх підприємств (МСП)', ro: 'Instrumente selectate pentru sprijinirea întreprinderilor mici și mijlocii (IMM-uri)', hy: 'Փոքր և միջին ձեռնարկություններին (ՓՄՁ) աջակցող ընտրված գործիքներ' },
