...
export const placeholderImages = [
  {
    ...
    alt: 'Placeholder image for journey phase content',
    caption: 'Placeholder caption text for a supporting journey phase image.'
  },
  {
    src: '/images/textiles.jpg',
    alt: 'Placeholder image for journey phase content',
    caption: 'Placeholder caption text for a second supporting journey phase image.'
  }
];
 ...
 *     checklist: string[];
 *   } | null;
 *   downloads: { phasePdf: string; toolsPdf: string };
 * }} config
 * @returns {any}
 */
