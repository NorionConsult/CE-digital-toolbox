...
Tools are generated as pages from `src/lib/content/editable/tools/tool-catalogue.js`,
not from PDF files. Add a PDF here only when a tool's `toolLink` should open or
